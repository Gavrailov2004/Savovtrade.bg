...
<div class="ProductSection">
    <section class="products">
        <h1 class="heading">Резултати от търсенето:</h1>
                ...
                while ($fetch_product = mysqli_fetch_assoc($select_products)) {
                    ...
                    <form action="" method="post">
                        <div class="box" style="border-color:<?php echo $fetch_product['color']; ?>">
                            ...
                            <h3 class="content1"><?php echo $fetch_product['name']; ?></h3>
                            <p class="content"><?php echo $fetch_product['description']; ?></p>
                            <?php
                            $select_products1 = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%$search%' AND Promo = 'Промоция'");
                            $hasPromo = false;
